...
import { addAdvertisement } from 'src/store/apps/advertisement'
...
const AdvertisementAdd = () => {
  ...
  const { loading, error } = useSelector(state => state.advertisements)
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (data.link_url?.trim()) {
        formData.append('link_url', data.link_url.trim())
      }
      ...
      // Dispatch action to add advertisement
      const result = await dispatch(addAdvertisement(formData)).unwrap()
      console.log('Advertisement added successfully:', result)
      ...
      setTimeout(() => {
        router.push('/apps/advertisement/list')
      }, 2000)
      
    } catch (err) {
      console.error('Error adding advertisement:', err)
      const errorMessage = err?.message || err || 'Failed to create advertisement'
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                ...
                <Box>
                  ...
                  <Typography variant='body1' color='text.secondary' sx={{ fontWeight: 500 }}>
                    Design and publish your creative advertisement
                  </Typography>
                </Box>
              </Box>
            }
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent sx={{ p: 6 }}>
              <Grid container spacing={6}>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange, onBlur } }) => (
                        <CustomTextField
                          ...
                          helperText={errors.title?.message || `${value?.length || 0}/100 characters`}
                          InputProps={{
                            startAdornment: (
                ...
                {/* 2. Banner Description Section */}
                <Grid item xs={12} md={6}>
                  <PreviewCard sx={{ p: 4, height: '100%' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Icon icon='tabler:file-text' fontSize='1.25rem' color='secondary' />
                      <Typography variant='h6' sx={{ ml: 2, fontWeight: 600 }}>
                        Description
                      </Typography>
                    </Box>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange, onBlur } }) => (
                        <CustomTextField
                          ...
                          onChange={onChange}
                          onBlur={onBlur}
                          placeholder='Describe your banner ad (optional)...'
                          error={Boolean(errors.description)}
                          helperText={errors.description?.message || `${value?.length || 0}/500 characters`}
                          InputProps={{
                            startAdornment: (
                ...
                <Grid item xs={12} md={6}>
                  <PreviewCard sx={{ p: 4, height: '100%' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Icon icon='tabler:currency-dollar' fontSize='1.25rem' color='success' />
                      <Typography variant='h6' sx={{ ml: 2, fontWeight: 600 }}>
                        Price
                      </Typography>
                    </Box>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange, onBlur } }) => (
                        <CustomTextField
                          ...
                          helperText={errors.price?.message || (value ? `Display: ${formatPrice(value)}` : 'Leave empty if not applicable')}
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                ...
                <Grid item xs={12} md={6}>
                  <PreviewCard sx={{ p: 4, height: '100%' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Icon icon='tabler:link' fontSize='1.25rem' color='info' />
                      <Typography variant='h6' sx={{ ml: 2, fontWeight: 600 }}>
                        Link URL
                      </Typography>
                    </Box>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange, onBlur } }) => (
                        <CustomTextField
                          ...
                          helperText={errors.link_url?.message || 'Where should users go when they click the banner?'}
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                ...
                <Grid item xs={12} md={6}>
                  <PreviewCard sx={{ p: 4, height: '100%' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Icon icon='tabler:eye-off' fontSize='1.25rem' color='warning' />
                      <Typography variant='h6' sx={{ ml: 2, fontWeight: 600 }}>
                        Visibility Settings
                      </Typography>
                    </Box>
                      ...
                      render={({ field: { value, onChange } }) => (
                        <Box>
                            ...
                            label={
                              <Box sx={{ ml: 1 }}>
                                ...
                                <Typography variant='body2' color='text.secondary'>
                                  {value 
                                    ? 'Banner will be hidden from public view' 
                          ...
                          <Box sx={{ 
                            ...
                            p: 2, 
                            borderRadius: 2, 
                            bgcolor: value ? 'warning.main' : 'success.main',
                            color: 'white'
                          }}>
                    ...
                    <PreviewCard sx={{ p: 4, height: '100%' }}>
                      ...
                      >
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          ...
                          <Chip 
                            label={watchedFields.is_hidden ? 'Hidden' : 'Visible'} 
                            color={watchedFields.is_hidden ? 'warning' : 'success'}
                            size='small'
                          />
                        </Box>
                      </Paper>
