...
// ** Actions Imports
import { fetchData, deleteCategory, publishCategory } from 'src/store/apps/category'
...
const VisibilityStatus = ({ row }) => {
  // ** Hooks
  const dispatch = useDispatch()

  const handleToggleVisibility = () => {
    dispatch(publishCategory(row.id))
  }
...
const columns = [
  ...
  },
  {
    ...
    renderCell: ({ row }) => <VisibilityStatus row={row} />
  },
  {
    flex: 0.1,
    minWidth: 100,
